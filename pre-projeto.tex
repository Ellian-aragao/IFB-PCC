...
% ---
\titulo{Comparação de ferramentas de sandboxing em sistemas GNU/Linux}
\autor{Ellian Aragão Dias, Joao Vitor Souza}
...
\areadepesquisa{Ferramentas de sandboxing em sistemas GNU/Linux}
\local{Brasília, DF}
\data{2023}
